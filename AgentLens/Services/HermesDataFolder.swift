...
/// Tool-written project files may be elsewhere; this is the canonical Hermes data root BurnBar already tracks.
@MainActor
enum HermesDataFolder {
    ...
    /// Opens Finder at a per-chat workspace (Application Support → BurnBar → HermesChatWorkspaces → thread).
