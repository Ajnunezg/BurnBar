...
enum BurnBarMemorySyncMode: String, Equatable, Sendable {
    case localFirstOptionalCloud = "local_first_optional_cloud"
    case cloudCanonical = "cloud_canonical"
}

enum BurnBarMemoryAuthority: String, Equatable, Sendable {
    case localSQLite = "local_sqlite"
    case cloudReplica = "cloud_replica"
}

struct BurnBarMemorySyncBoundarySnapshot: Equatable, Sendable {
    let mode: BurnBarMemorySyncMode
    let canonicalAuthority: BurnBarMemoryAuthority
...
final class CloudSyncService {
    ...
    ) -> BurnBarMemorySyncBoundarySnapshot {
        BurnBarMemorySyncBoundarySnapshot(
    ...
    func memorySyncBoundarySnapshot() -> BurnBarMemorySyncBoundarySnapshot {
    ...
    private static let lastRemoteDownloadKey = "com.burnbar.lastRemoteDownloadAt"
