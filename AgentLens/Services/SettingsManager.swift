...
final class SettingsManager {
    ...
    /// Empty lets BurnBar pick automatically: if the gateway’s `/v1/models` advertises MiniMax but you use Codex with a ChatGPT account, BurnBar sends a Codex-supported model instead (see `resolvedHermesChatModel(gatewayAdvertisedModel:)`).
