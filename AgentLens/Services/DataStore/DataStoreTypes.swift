...
struct BurnBarLocalAuthoritySnapshot: Equatable, Sendable {
...
struct BurnBarOperatingActionRecord: Identifiable, Equatable, Sendable {
    let id: String
    let projectName: String
    let missionFingerprint: String?
    let actionKind: BurnBarActionKind
    let summary: String
    let detail: String?
    let overrideMode: BurnBarDirectionOverrideModeKind?
    let forcedDirectionStatus: BurnBarDirectionAssessment?
    let createdAt: Date
    ...
    init(
        ...
        actionKind: BurnBarActionKind,
        summary: String,
        detail: String? = nil,
        overrideMode: BurnBarDirectionOverrideModeKind? = nil,
        forcedDirectionStatus: BurnBarDirectionAssessment? = nil,
        createdAt: Date = Date()
    ) {
        self.id = id
        self.projectName = projectName
