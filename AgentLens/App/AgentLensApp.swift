...
final class WindowManager: ObservableObject {
    ...
    func openOnboardingWizard(
        ...
        window.title = "Welcome to BurnBar"
        window.titleVisibility = .hidden
        window.titlebarAppearsTransparent = true
        window.backgroundColor = NSColor(DesignSystem.Colors.background)
        window.contentView = NSHostingView(rootView: contentView)
...
struct BurnBarApp: App {
    ...
    @State private var operatingLayer: BurnBarOperatingLayer
        ...
        MenuBarExtra {
            ...
            if BurnBarRuntime.isRunningTests {
                ...
                .task {
                    ...
                    BurnBarDaemonManager.shared.attach(dataStore: dataStore)
                    ...
                    Task {
                        ...
                        await BurnBarDaemonManager.shared.refreshHealth()
