...
struct DatabaseWorkspaceView: View {
            ...
            VStack(alignment: .leading, spacing: DesignSystem.Spacing.lg) {
                ...
                indexProgressRow(
                    ...
                    detail: indexingInProgress
                        ...
                        : "Projected coverage is current for the records BurnBar knows about."
                )
    ...
    private var selectionWarning: String? {
        ...
        return "The selected index version differs from the currently served semantic version. BurnBar will prefer the selected version for new retrieval sessions, but queued or stale embeddings can still leave search in lexical fallback until re-embedding catches up."
    }
