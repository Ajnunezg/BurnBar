...
struct ProjectsView: View {
    ...
    @State private var daemonManager: BurnBarDaemonManager
                ...
                if mergedProjects.isEmpty {
                    VStack(spacing: DesignSystem.Spacing.lg) {
                        ...
                        Text("No projects yet")
                            ...
                            .foregroundStyle(DesignSystem.Colors.textSecondary)
                        Text("Projects appear when BurnBar scans agent sessions or you register one for scheduled reviews.")
                            .font(DesignSystem.Typography.caption)
                            .foregroundStyle(DesignSystem.Colors.textMuted)
...
private struct ProjectHubView: View {
    ...
    private var missions: [BurnBarControllerMissionRecord] {
...
private struct ControllerProjectDraft: Identifiable {
    ...
    func snapshot() -> BurnBarReviewProjectSnapshot {
        ...
        return BurnBarReviewProjectSnapshot(
            ...
            summary: summary.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty ? "Native BurnBar controller registry project." : summary.trimmingCharacters(in: .whitespacesAndNewlines),
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: DesignSystem.Spacing.lg) {
            Text(draft.existingProjectID == nil ? "Add Review Project" : "Edit Review Project")
                .font(DesignSystem.Typography.title)
                .foregroundStyle(DesignSystem.Colors.textPrimary)
            Text("This saves BurnBar's default review style and optional automatic schedule for a project.")
                .font(DesignSystem.Typography.caption)
                .foregroundStyle(DesignSystem.Colors.textMuted)
                .fixedSize(horizontal: false, vertical: true)
