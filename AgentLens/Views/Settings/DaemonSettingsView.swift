                ...
                GlassCard {
                    VStack(alignment: .leading, spacing: DesignSystem.Spacing.md) {
                        SettingsToggle(
                            ...
                            subtitle: "Keep the daemon-backed missions, followups, questions, and replay state active in BurnBar.",
                            icon: "cpu",
                        ...
                        HStack {
                            VStack(alignment: .leading, spacing: 2) {
                                ...
                                Text("How often BurnBar refreshes the mirrored controller runtime.")
                                    .font(DesignSystem.Typography.tiny)
                                    .foregroundStyle(DesignSystem.Colors.textMuted)
                            }
                            Spacer()
