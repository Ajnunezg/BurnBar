            ...
            VStack(alignment: .leading, spacing: DesignSystem.Spacing.md) {
                HStack {
                    VStack(alignment: .leading, spacing: 2) {
                        ...
                        Text("Choose whether BurnBar follows the system, stays light, or stays dark.")
                ...
                SettingsToggle(
                    ...
                    subtitle: "Keep BurnBar available as a menu-bar utility.",
                ...
                SettingsToggle(
                    ...
                    subtitle: "Start BurnBar when you sign in to macOS.",
