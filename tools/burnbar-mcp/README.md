...
This helper is an optional developer tool, not part of BurnBar's core runtime or release-critical surface. Its Python dependency is intentionally pinned in `requirements.txt` so the install is reviewable and reproducible.
...
BurnBar treats this as adjacent tooling:
...
- best-effort support compared with the core BurnBar surfaces
