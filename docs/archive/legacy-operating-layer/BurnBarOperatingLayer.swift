...
// MARK: - Note
//
// This file is intentionally excluded from the `OpenBurnBar.app` Xcode build target
...
final class BurnBarOperatingLayer {
    ...
    func answerPendingQuestion(id: String, answer: String, selectedOptionID: String? = nil) async {
        ...
        guard trimmed.isEmpty == false else {
            controllerFeedback = BurnBarControllerFeedback(tone: .error, message: "Write an answer before sending it to OpenBurnBar.")
            return
        }
        ...
        do {
            ...
            controllerFeedback = BurnBarControllerFeedback(tone: .success, message: "Answer recorded in OpenBurnBar’s controller history.")
            stateRevision += 1
        } catch {
            controllerFeedback = BurnBarControllerFeedback(tone: .error, message: "OpenBurnBar could not record that answer: \(error.localizedDescription)")
        }
    }
    ...
    func completeFollowup(id: String) async {
        do {
            ...
            controllerFeedback = BurnBarControllerFeedback(tone: .error, message: "OpenBurnBar could not complete that followup: \(error.localizedDescription)")
        }
    }
    ...
    func snoozeFollowup(id: String, until: Date) async {
        do {
            ...
            controllerFeedback = BurnBarControllerFeedback(tone: .error, message: "OpenBurnBar could not snooze that followup: \(error.localizedDescription)")
        }
    }
    ...
    func scheduleFollowupCalendar(id: String, title: String? = nil) async {
        ...
        do {
            ...
            controllerFeedback = BurnBarControllerFeedback(tone: .error, message: "OpenBurnBar could not add that calendar hold: \(error.localizedDescription)")
        }
    }
}
