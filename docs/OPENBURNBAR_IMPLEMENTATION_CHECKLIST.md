# OpenBurnBar Implementation Checklist
...
- Keep `OpenBurnBarCore` as the shared home for RPC contracts, catalog metadata, and run-state types.
...
- Swift package tests pass for `OpenBurnBarCore` and `OpenBurnBarDaemon`.
