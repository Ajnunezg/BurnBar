...
<html lang="en">
  ...
  <body>
    <div class="bw-workspace">
      ...
      <!-- ── Section Rail ─────────────────────────────── -->
      <nav class="bw-rail" aria-label="BurnBar sections">
        <div class="bw-rail-brand">
          <img class="bw-rail-logo" src="${logoUri}" width="26" height="26" alt="BurnBar" />
        </div>
      ...
      <main class="bw-canvas">
        ...
        <section class="bw-section bw-section--active" data-section="command">
          ...
          <div class="bw-composer">
            <textarea class="bw-composer-input" placeholder="Describe what BurnBar should do\u2026" rows="3" aria-label="Run prompt"></textarea>
