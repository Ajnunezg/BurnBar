/* ============================================================
   BurnBar Workspace — Editor Pane Webview
  ...
  if (!vm.isConnected || vm.noRunsYet) {
    ...
    const msg = el('div', 'bw-command-run-empty-msg',
      vm.isDaemonUnavailable
        ? 'Connect the BurnBar daemon to start running agent tasks from this workspace.'
        : 'Use the composer below to describe a task. BurnBar will plan, read, edit, and run commands in your workspace.');
